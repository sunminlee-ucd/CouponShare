...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="ko">
      <body><LanguageProvider><AppSidebar />{children}<DunnesMembershipGuard /><MyVoucherReservationStatus /><PublicVoucherReservationStatus /><HomeInstallGuide /><LoginLanguageSwitcher /></LanguageProvider></body>
    </html>
  );
}
