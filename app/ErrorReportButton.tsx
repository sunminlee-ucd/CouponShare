...
export default function ErrorReportButton({ deviceKey: _deviceKey, embedded = false, onOpen }: Props) {
  void _deviceKey;
  const { t } = useLanguage();
  ...
  return (
    <>
      <button className={`topbar-error-button ${styles.button}${embedded ? ` ${styles.embedded}` : ""}`} type="button" onClick={openReport}>
