...
export default function LoginPage() {
  ...
  const copy = useMemo(() => language === "en" ? {
    ...
    passwordHint: "8文字以上",
    confirmPasswordHint: "同じパスワードをもう一度入力してください",
    passwordMismatch: "パスワードが一致しません。",
    autoLogin: "ログイン状態を保持",
    autoLoginHint: "この端末で最大30日間保持します。",
    submit: mode === "login" ? "メールでログイン" : "メールでアカウント作成",
    or: "または",
    google: "Googleで続ける",
    browse: "ログインせずに見る",
    browseHint: "閲覧のみ可能です。登録や予約にはログインが必要です。",
    signupSuccess: "アカウントを作成しました。",
    loginSuccess: "ログインしました。",
    confirmation: "確認メールを送信しました。メールでアカウントを確認してからCouponShareに戻ってください。",
    redirecting: "CouponShareに移動しています…",
    continue: "CouponShareに進む",
    sessionError: "認証は完了しましたが、CouponShareのログインセッションを確認できませんでした。もう一度お試しください。",
    error: "ログインまたは新規登録を完了できませんでした。入力内容を確認してもう一度お試しください。",
    invalidCredentials: "メールアドレスまたはパスワードが正しくありません。",
    emailNotConfirmed: "メール認証を完了してからログインしてください。",
    alreadyRegistered: "このメールアドレスはすでに登録されています。ログインをお試しください。",
    oauthError: "Google認証を開始できませんでした。もう一度お試しください。",
    oauthConfigError: "サーバーのGoogleログイン設定が完了していません。",
    emailWorking: mode === "login" ? "ログイン中…" : "アカウントを作成中…",
    oauthWorking: "Googleアカウント選択画面を開いています…",
    workingHint: "このページを閉じずにお待ちください。",
    browseError: "閲覧モードを開始できませんでした。もう一度お試しください。",
  } : {
    eyebrow: "COUPONSHARE",
